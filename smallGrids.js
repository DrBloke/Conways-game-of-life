...
var _user$project$Main$cartesianProduct = F2(
	function (xs, ys) {
		return A3(
			_elm_community$list_extra$List_Extra$lift2,
			F2(
...
var _user$project$Main$emptyGrid = A2(
	_user$project$Main$cartesianProduct,
	A2(_elm_lang$core$List$range, 1, 10),
	A2(_elm_lang$core$List$range, 1, 7));
var _user$project$Main$getNeighboursCoords = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1._1;
	var _p2 = _p1._0;
	return {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: _p2 - 1, _1: _p3 - 1},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _p2, _1: _p3 - 1},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: _p2 + 1, _1: _p3 - 1},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _p2 - 1, _1: _p3},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _p2 + 1, _1: _p3},
						_1: {
...
var _user$project$Main$getNeighboursIfDead = F3(
	function (liveCells, cell, deadNeighbours) {
		var neighbours = _user$project$Main$getNeighboursCoords(cell);
		var newDeadNeighbours = A2(
			_elm_lang$core$List$filter,
			function (thisNeighbour) {
				return !A2(_elm_lang$core$List$member, thisNeighbour, liveCells);
			},
			neighbours);
		return A2(_elm_lang$core$List$append, newDeadNeighbours, deadNeighbours);
	});
var _user$project$Main$liveNeighboursOfCell = F2(
	function (liveCells, coords) {
		return A2(
			_elm_lang$core$List$filter,
			A2(_elm_lang$core$Basics$flip, _elm_lang$core$List$member, liveCells),
			_user$project$Main$getNeighboursCoords(coords));
	});
var _user$project$Main$numLiveNeighbours = F2(
	function (liveCells, coords) {
		return _elm_lang$core$List$length(
			A2(_user$project$Main$liveNeighboursOfCell, liveCells, coords));
	});
var _user$project$Main$applyGameRules = function (liveCells) {
	var deadCellsThatComeToLife = A2(
		_elm_lang$core$List$filter,
		function (coords) {
			return _elm_lang$core$Native_Utils.eq(
				A2(_user$project$Main$numLiveNeighbours, liveCells, coords),
				3);
		},
		_elm_community$list_extra$List_Extra$unique(
			A3(
				_elm_lang$core$List$foldl,
				_user$project$Main$getNeighboursIfDead(liveCells),
				{ctor: '[]'},
				liveCells)));
	var liveCellsThatContiueToLive = A2(
		_elm_lang$core$List$filter,
		function (coords) {
			return (_elm_lang$core$Native_Utils.cmp(
				A2(_user$project$Main$numLiveNeighbours, liveCells, coords),
		...
		liveCells);
	return A2(_elm_lang$core$List$append, liveCellsThatContiueToLive, deadCellsThatComeToLife);
};
var _user$project$Main$toggleClickedCellState = F2(
	function (clickedCoords, liveCells) {
		return A2(_elm_lang$core$List$member, clickedCoords, liveCells) ? A2(
			_elm_lang$core$List$filter,
			function (x) {
				return !_elm_lang$core$Native_Utils.eq(x, clickedCoords);
			},
			liveCells) : {ctor: '::', _0: clickedCoords, _1: liveCells};
	});
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {grid: a, liveCells: b, rulesOfTheGame: c, showGridLines: d, zoomLevel: e, inProgress: f, generationTime: g, generations: h};
	});
var _user$project$Main$Rules = F4(
	function (a, b, c, d) {
		return {minNeighbours: a, maxNeighbours: b, spawnNeighbours: c, edgeRule: d};
	});
var _user$project$Main$Toroid = {ctor: 'Toroid'};
var _user$project$Main$Escape = {ctor: 'Escape'};
var _user$project$Main$Bounded = {ctor: 'Bounded'};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {
		grid: _user$project$Main$emptyGrid,
		liveCells: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 50, _1: 30},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 51, _1: 30},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 50, _1: 31},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 49, _1: 31},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 50, _1: 32},
							_1: {ctor: '[]'}
						}
					}
				}
		...
		rulesOfTheGame: A4(_user$project$Main$Rules, 2, 3, 3, _user$project$Main$Bounded),
		showGridLines: true,
		zoomLevel: 1,
		inProgress: false,
		generationTime: 1000,
...
var _user$project$Main$Infinite = {ctor: 'Infinite'};
var _user$project$Main$Acorn = {ctor: 'Acorn'};
var _user$project$Main$Diehard = {ctor: 'Diehard'};
var _user$project$Main$RPentomino = {ctor: 'RPentomino'};
var _user$project$Main$Glider = {ctor: 'Glider'};
var _user$project$Main$Pentadecathlon = {ctor: 'Pentadecathlon'};
var _user$project$Main$Beacon = {ctor: 'Beacon'};
var _user$project$Main$Toad = {ctor: 'Toad'};
var _user$project$Main$Blinker = {ctor: 'Blinker'};
var _user$project$Main$Beehive = {ctor: 'Beehive'};
var _user$project$Main$Block = {ctor: 'Block'};
var _user$project$Main$PlacePatternOnGrid = F2(
	function (a, b) {
		return {ctor: 'PlacePatternOnGrid', _0: a, _1: b};
	});
var _user$project$Main$Select = function (a) {
	return {ctor: 'Select', _0: a};
};
var _user$project$Main$ChangeRules = function (a) {
	return {ctor: 'ChangeRules', _0: a};
};
var _user$project$Main$ChangeGenerationTime = function (a) {
	return {ctor: 'ChangeGenerationTime', _0: a};
};
var _user$project$Main$ChanageZoomLevel = function (a) {
	return {ctor: 'ChanageZoomLevel', _0: a};
};
var _user$project$Main$ToggleGridLines = {ctor: 'ToggleGridLines'};
var _user$project$Main$ToggleView = {ctor: 'ToggleView'};
var _user$project$Main$OutputGameState = {ctor: 'OutputGameState'};
var _user$project$Main$InputGameState = {ctor: 'InputGameState'};
var _user$project$Main$UpdateGameState = {ctor: 'UpdateGameState'};
	...
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p4.ctor) {
				case 'CellClick':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								liveCells: A2(_user$project$Main$toggleClickedCellState, _p4._0, model.liveCells)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'UpdateGameState':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								liveCells: _user$project$Main$applyGameRules(model.liveCells),
				...
				case 'Tick':
					if (_p4._0) {
						var _v2 = _user$project$Main$UpdateGameState,
							_v3 = model;
						msg = _v2;
						model = _v3;
						continue update;
...
var _user$project$Main$skipNextButton = A2(
	_elm_lang$svg$Svg$svg,
	{
		ctor: '::',
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Events$onClick(_user$project$Main$UpdateGameState),
				_1: {ctor: '[]'}
			}
		}
	},
	{
		ctor: '::',
		_0: A2(_elm_community$elm_material_icons$Material_Icons_Av$skip_next, _elm_lang$core$Color$black, 50),
		_1: {ctor: '[]'}
	});
...
var _user$project$Main$subscriptions = function (model) {
	return A2(
		...
		_user$project$Main$Tick(model.inProgress));
};
var _user$project$Main$ToggleInProgress = {ctor: 'ToggleInProgress'};
var _user$project$Main$playOrPauseButton = function (inProgress) {
	var button = inProgress ? _elm_community$elm_material_icons$Material_Icons_Av$pause_circle_filled : _elm_community$elm_material_icons$Material_Icons_Av$play_circle_filled;
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Events$onClick(_user$project$Main$ToggleInProgress),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			ctor: '::',
			_0: A2(button, _elm_lang$core$Color$black, 50),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$renderEmptyCell = function (coords) {
	return A2(
		_elm_lang$svg$Svg$rect,
		{
			...
			_0: _elm_lang$svg$Svg_Attributes$x(
				_elm_lang$core$Basics$toString(
					(_elm_lang$core$Tuple$first(coords) * 100) - 100)),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$y(
					_elm_lang$core$Basics$toString(
						(_elm_lang$core$Tuple$second(coords) * 100) - 100)),
				_1: {
					ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$svg$Svg_Events$onClick(
											_user$project$Main$CellClick(coords)),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Main$drawGrid = function (grid) {
	return A2(_elm_lang$core$List$map, _user$project$Main$renderEmptyCell, grid);
};
var _user$project$Main$renderLiveCell = function (coords) {
	return A2(
		_elm_lang$svg$Svg$rect,
		{
			ctor: '::',
...
var _user$project$Main$drawLiveCells = function (liveCells) {
	return A2(_elm_lang$core$List$map, _user$project$Main$renderLiveCell, liveCells);
};
			...
			_0: A2(
				_elm_lang$svg$Svg$svg,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$height(
							_elm_lang$core$Basics$toString(700)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$viewBox(' 0 0 1000 700'),
							_1: {ctor: '[]'}
						}
					}
				},
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Main$drawGrid(model.grid),
					_user$project$Main$drawLiveCells(model.liveCells))),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(model.generations)),
				_1: {
					ctor: '::',
					_0: _user$project$Main$playOrPauseButton(model.inProgress),
					_1: {
						ctor: '::',
						_0: _user$project$Main$skipNextButton,
						_1: {ctor: '[]'}
					}
				}
			}
